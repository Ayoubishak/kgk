...
namespace Biblio
{
    public partial class Dessinateur : Form
    {
        ...
        private void windowsUIButtonPanel1_ButtonClick(object sender, DevExpress.XtraBars.Docking2010.ButtonEventArgs e)
        {
            if (e.Button == windowsUIButtonPanel1.Buttons[0])
            {
                ...
                string sql3 = "select [Dess_Intitule] from [dbo].[P_Dessinateur] where [Dess_Intitule]='" + textBox_Inti.Text.Trim() + "'";
                ...
                cmdAjouterB.CommandText = "INSERT INTO [dbo].[P_Dessinateur] ([Dess_Intitule],[Dess_Statut]) VALUES  (@Intitule,@Statut)";
                ...
                gridControl_Dist.DataSource = ds;
                gridControl_Dist.DataMember = "table";
                gridView_Dist.BestFitColumns();
        ...
        private void repositConsulter_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                textBox_CodeFormats.Text = gridView_Dist.GetRowCellValue(gridView_Dist.FocusedRowHandle, "Dess_Id").ToString();
                textBox_Inti.Text = gridView_Dist.GetRowCellValue(gridView_Dist.FocusedRowHandle, "Dess_Intitule").ToString();
                var Statu = gridView_Dist.GetRowCellValue(gridView_Dist.FocusedRowHandle, "Dess_Statut").ToString();
        ...
        private void reposSup_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                var ID = gridView_Dist.GetRowCellValue(gridView_Dist.FocusedRowHandle, "Dess_Id").ToString();

                if (ID != "" || ID != null)
                {

                    SqlCommand Del = new SqlCommand();
                    Del.CommandText = "delete [dbo].[P_Dessinateur]  where [Dess_Id]='" + Int32.Parse(ID) + "'";
